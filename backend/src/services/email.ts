...
export async function sendMagicLinkEmail({ to, magicLinkUrl }: SendMagicLinkEmailArgs) {
  ...
  const heading = isExisting ? "You've received a badge!" : 'Create your account to view your badge';
  ...
  const cta = isExisting ? 'View Your Badge' : 'Create Account';
  ...
  const subject = isExisting ? "You've received a badge!" : 'Create your account to view your badge';
