...
export const Route = createFileRoute("/onboard/create-org")({
...
function CreateOrgPage() {
  ...
  React.useEffect(() => {
    async function validateToken() {
      ...
      try {
        ...
        setOrgName(data.invitation.organizationName || "");
      } catch (e) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    try {
      const resp = await fetchWithAuth("invitations/complete-org-creation", {
        method: "POST",
        body: JSON.stringify({
          token,
          password,
